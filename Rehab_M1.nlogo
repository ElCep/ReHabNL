...
to setup
  ...
  foreach[0 -1 -2 -3][ y ->
    foreach[0 1 2 3 4][
      x -> ask patch x y [
        set biomass first biomassList
        set biomassList but-first biomassList
      ]
    ]
  ]
  ...
  while [any? harvesters with [myClan = 0]][
    ask clans [
      if any? harvesters with [myClan = 0][
        ask one-of harvesters with[myClan = 0][
